...
| Name | Author(s) | Institution |Link | Notes |
|------|-----------|-------------|-----|-------|
| AcMC²: Accelerating Markov Chain Monte Carlo Algorithms for Probabilistic Models| Subho S. Banerjee *et al*| University of Illinois at Urbana-Champaign |  [Paper](https://dl.acm.org/doi/10.1145/3297858.3304019) | Compiler development transorming probabilistic models into optimized hardware accelerators |
